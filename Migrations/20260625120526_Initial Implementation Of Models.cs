...
{
    /// <inheritdoc />
    public partial class InitialImplementationOfModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineSupplier", x => new { x.MedicinesId, x.SuppliersId });
                    table.ForeignKey(
                        name: "FK_MedicineSupplier_Medicines_MedicinesId",
                        column: x => x.MedicinesId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicineSupplier_Suppliers_SuppliersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineSupplier_SuppliersId",
